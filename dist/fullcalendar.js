...
var EventResizing = /** @class */ (function (_super) {
    ...
    */
            ...
            hitOver: function (hit, isOrig, origHit) {
                ...
                if (origHitFootprint && hitFootprint) {
                    resizeMutation = isStart ?
                        ...
                        _this.computeEventEndResizeMutation(origHitFootprint, hitFootprint, seg.footprint, seg.resizeOptions);
                    if (resizeMutation) {
    ...
    EventResizing.prototype.computeEventEndResizeMutation = function (startFootprint, endFootprint, origEventFootprint, options) {
        var origRange = origEventFootprint.componentFootprint.unzonedRange;
        var endDelta = this.component.diffDates(endFootprint.unzonedRange.getEnd(), startFootprint.unzonedRange.getEnd());
        var dateMutation = new EventDefDateMutation_1.default();
        ...
        if (options.minEventDuration && origRange.getStart().add(endDelta) < origRange.getStart()) {
            dateMutation.setEndDelta(this.component.diffDates(origRange.getStart(), origRange.getEnd())
